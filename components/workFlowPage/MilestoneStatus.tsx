...
interface MilestoneStatusProps {
  ...
  onStatusChange: (newStatus: "pending" | "submitted" | "confirmed" | "paid") => void
}

export function MilestoneStatus({ status, onStatusChange }: MilestoneStatusProps) {
    ...
    <>
      <div className="border-t ml-6 mt-6 p-6">
        <div className="flex gap-6 text-sm mb-6">
          <button className="border-b-2 border-gray-900 pb-2">Active milestones (01)</button>
  ...
  <div className="space-y-2 ml-6">
    ...
    <div className="flex">
      <Button className="ml-auto mr-8" onClick={() => onStatusChange("submitted")}>
        Submit Work
      </Button>
    </div>
  </div>
      ...
      <Dialog open={showConfirmation} onOpenChange={setShowConfirmation}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              If you choose yes, then the amount of $200 Fee milestone will be sent to the freelancer's account.
            </DialogDescription>
          </DialogHeader>
