...
const WhyUsCard = ({ image, title, description }: whyUsCardProps) => {
  return (
    <div className="w-full max-w-[360px] h-auto flex flex-col items-center justify-center lg:gap-y-4 gap-y-2 px-4">
      ...
      <div
        className={` text-center flex flex-col gap-y-2 ${montserrat.className}`}
      >
